    ...
    <footer className="bg-muted/50 border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground text-sm">
              Your premier destination for elegant and stylish dresses. Quality fashion that makes you feel confident
              and beautiful.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-muted-foreground">info@Parizah Vogue.com</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; 2024 Parizah Vogue. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
